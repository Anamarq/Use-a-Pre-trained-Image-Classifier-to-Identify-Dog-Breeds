...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic["n_dogs_matches"] = 0
    #Number of Dog Images
    results_stats_dic["n_dogs_img"] = 0
    #Number of Correct Non-Dog matches
    results_stats_dic["n_non_dog_matches"] = 0
    # Number of Correct Breed matches
    results_stats_dic["n_breed_matches"] = 0
    ...
    results_stats_dic["pct_correct_dogs"] = results_stats_dic["n_dogs_matches"] / results_stats_dic["n_dogs_img"] * 100
    # Percentage of Correctly Classified Non-Dog Images
    if results_stats_dic["n_notdogs_img"] > 0:
        results_stats_dic["pct_correct_notdogs"] = results_stats_dic["n_non_dog_matches"] / results_stats_dic["n_notdogs_img"] * 100
    # Percentage of Correctly Classified Dog Breeds
    results_stats_dic["pct_correct_breed"] = results_stats_dic["n_breed_matches"] / results_stats_dic["n_dogs_img"] * 100
